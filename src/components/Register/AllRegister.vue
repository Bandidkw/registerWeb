  ...
  >
    ...
    <div class="w-full p-12 sm:w-8/12 md:w-1/2 lg:w-5/12">
      ...
      <div class="mt-6">
        ...
        <div class="flex justify-between gap-3">
          <span class="w-1/2">
            ...
            <input
              ...
              class="focus:text-black rounded-lg block w-full p-3 mt-2 text-white bg-gray-700 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner"
            />
          </span>
          <span class="w-1/2">
            <label class="block text-xs font-semibold text-gray-600 uppercase"
        ...
        <button
          @click="sentregister"
          class="rounded-lg w-full py-3 mt-6 font-medium tracking-widest text-white uppercase bg-black shadow-lg focus:outline-none hover:bg-gray-900 hover:shadow-none"
        >
          สมัคร
        </button>
      </div>
...
const registerInvestor = async () => {
  try {
    const response = await axios.post(
      ...
      {
        investor_name: landlord_name.value,
        investor_phone: landlord_phone.value,
        investor_iden: landlord_iden.value,
        investor_email: landlord_email.value,
        investor_address: landlord_address.value,
        investor_password: landlord_password.value,
        investor_subdistrict: landlord_subdistrict.value,
        investor_district: landlord_district.value,
        investor_province: landlord_province.value,
        investor_postcode: landlord_postcode.value,
      }
    );
    showSuccess();
    setTimeout(() => {
